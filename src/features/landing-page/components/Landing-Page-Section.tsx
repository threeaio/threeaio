...
export const LandingPageSection: ParentComponent = (props) => {
  ...
  return (
    <section class="section h-screen  mx-auto [ px-4 py-8 lg:px-16 lg:py-16 ]">
      ...
      <div class="w-full h-full  relative [ grid grid-cols-1 lg:grid-cols-12 lg:grid-rows-3 gap-0 items-center ]  ">
        {stuff}
